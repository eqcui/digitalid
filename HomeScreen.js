...
const styles = StyleSheet.create({
  ...
  focusedCard: { width: 260, height: 120, backgroundColor: '#282A2D', borderRadius: 8, padding: 16, marginRight: 15, position: 'relative', overflow: 'hidden' },
focusedTitle: { color: 'white', fontSize: 19, fontWeight: 'bold' },
  ...
  unfocusedCard: { width: 190, height: 95, backgroundColor: '#282A2D', borderRadius: 12, padding: 12, marginRight: 15, position: 'relative', overflow: 'hidden' },
